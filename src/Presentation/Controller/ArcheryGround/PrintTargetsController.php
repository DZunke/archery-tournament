...
final class PrintTargetsController extends AbstractController
{
    public function __construct(private readonly QueryBus $queryBus)
    {
    }

    #[Route('/archery-grounds/{id}/print-targets', name: 'archery_ground_print_targets', methods: ['GET'])]
    public function __invoke(string $id): Response
    {
        ...
        return $this->render('archery_ground/print_targets.html.twig', [
