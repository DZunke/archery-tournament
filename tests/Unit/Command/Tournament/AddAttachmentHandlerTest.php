...
use App\Application\Command\Tournament\AddAttachment;
use App\Application\Command\Tournament\AddAttachmentHandler;
...
final class AddAttachmentHandlerTest extends TestCase
{
    ...
    public function addsAttachmentSuccessfully(): void
    {
        ...
        self::assertStringContainsString('Tournament Rules', (string) $result->message);
        ...
        self::assertSame('Tournament Rules', $addedAttachment->title());
    ...
    public function addsImageAttachmentSuccessfully(): void
    {
        ...
        $addedAttachment = $repository->addedAttachments[0]['attachment'];
        self::assertSame('Tournament Photo', $addedAttachment->title());
